...
const FACEBOOK_APP_ID = '288234017162342';
const FACEBOOK_APP_SECRET = '0c8082c30473d69ac6844cb2c1fc9960';
  ...
  new FacebookStrategy(
    {
      ...
      // Your callback URL
      callbackURL: 'https://jubilant-telegram-x6xjprgw5gj3vgx6-5050.app.github.dev/facebook/callback', 
...
app.get('/facebook/callback', passport.authenticate('facebook', {
  ...
  successRedirect: 'https://jubilant-telegram-x6xjprgw5gj3vgx6-3000.app.github.dev/home', 
  // Redirect to login page on authentication failure.
  failureRedirect: 'https://jubilant-telegram-x6xjprgw5gj3vgx6-3000.app.github.dev/', 
}));
